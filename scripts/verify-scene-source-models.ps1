...
Require-Text $cuda "return gasBurnerPortEmitter(x, z, h, p);" "gas burner scene has fallen back to generic fuel-bed material"
...
Require-Text $cuda "scenePyrolysisGain = p.sceneId == 2 ? 0.90f : (p.sceneId == 1 ? 1.34f" "scene-specific pyrolysis gains are missing"
