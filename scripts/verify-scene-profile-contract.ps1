...
Require-Text $cuda "p.sceneInitialHeatBase" "CUDA reset seeding must consume scene-profile heat coefficients"
...
Require-Text $sceneRuntime "settings.sceneInitialHeatBase = source.initialHeatBase" "scene runtime must copy source coefficients into FireSettings"
