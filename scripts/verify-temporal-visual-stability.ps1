...
Require-Text $main "constexpr unsigned long long kWorkerFrameStaleMs = 40ull" "displayed CUDA frame freshness budget must match the temporal analyzer"
...
Require-Text $main "kWorkerPhysicsFrameInterval <= 1" "worker physics interval of 1 must not emit render-only frames"
