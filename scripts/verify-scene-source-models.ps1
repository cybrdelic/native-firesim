...
Require-Text $sceneAssets "sceneCoordinateTranslationMeters(sceneId, sceneContract)" "scene coordinate translation contract is not centralized"
Require-Text $sceneAssets "applySceneCoordinateTranslation(" "scene-to-sim point transform is not centralized"
